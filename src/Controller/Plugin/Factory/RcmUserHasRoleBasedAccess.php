...
namespace RcmUser\Api\Controller\Plugin\Factory;

use RcmUser\Api\Controller\Plugin\RcmUserIsAllowed;
...
class RcmUserHasRoleBasedAccess implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $mgr)
    {
        ...
        $service = new \RcmUser\Api\Controller\Plugin\RcmUserHasRoleBasedAccess(
